...
class OrderCardBuilder extends StatelessWidget {
  const OrderCardBuilder({
    Key key,
            ...
            return Padding(
              ...
              child: SizedBox(
                ...
                child: GestureDetector(
                  onTap: () => {
                    Navigator.pushNamed(context, Routes.transaction_details,
                        arguments: {
                          'service': service,
                          'user': user,
                          'transaction': order,
                              ...
                              border: Border.all(
                                color: order.transactionType == "On Going"
                                    ...
                                    : order.transactionType == "Cancelled"
                                        ? Colors.pink
                                        : order.transactionType == "Planned"
                                            ? Colors.deepOrangeAccent
                                            : Colors.green,
                              ),
                              borderRadius: BorderRadius.circular(29),
                              gradient: order.transactionType == "On Going"
                                  ? kPrimaryGradient
                                  : order.transactionType == "Cancelled"
                                      ? kRedGradient
                                      : order.transactionType == "Planned"
